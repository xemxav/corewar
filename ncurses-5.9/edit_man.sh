...
*.[0-9]*)
	...
	if test ! -f /Users/tduverge/projet/test_corewar/ncurses-5.9/man_alias.sed ; then
cat >>/Users/tduverge/projet/test_corewar/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/tduverge/projet/test_corewar/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Users/tduverge/projet/test_corewar/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /Users/tduverge/projet/test_corewar/ncurses-5.9/man_alias.sed \
		< $i >$TMP
